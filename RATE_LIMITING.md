...
В проекте реализована система ограничения запросов, которая ограничивает количество API запросов до 1 запроса в 90 секунд для каждого источника.
...
- Максимум запросов в окне: 1
- Время окна: 90000 мс (90 секунд)
- Интервал ожидания при превышении лимита: до сброса счетчика или 1 секунда
